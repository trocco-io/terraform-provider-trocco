resource "trocco_snowflake_datamart_definition" "test_snowflake_datamart_missing_incremental_fields" {
  name                     = "test_snowflake_datamart_missing_incremental_fields"
