...
func (bigqueryOutputOption *BigQueryOutputOption) ToInput() *output_options2.BigQueryOutputOptionInput {
	...
	return &output_options2.BigQueryOutputOptionInput{
		...
		TimePartitioningRequirePartitionFilter: bigqueryOutputOption.TimePartitioningRequirePartitionFilter.ValueBool(),
		...
		BeforeLoad:                             models.NewNullableString(bigqueryOutputOption.BeforeLoad),
