...
func NewCustomConnectorInputOption(
	...
	return &CustomConnectorInputOption{
		...
		URL:                         types.StringPointerValue(inputOption.URL),
		AuthType:                    types.StringPointerValue(inputOption.AuthType),
		...
		EndpointPath:                types.StringPointerValue(inputOption.EndpointPath),
		EndpointMethod:              types.StringPointerValue(inputOption.EndpointMethod),
		EndpointRequestBody:         types.StringPointerValue(inputOption.EndpointRequestBody),
		SuccessCodes:                types.StringPointerValue(inputOption.SuccessCodes),
		NotRetryableCodes:           types.StringPointerValue(inputOption.NotRetryableCodes),
