...
func NewHttpInputOption(ctx context.Context, httpInputOption *entity.HttpInputOption, previous *HttpInputOption) (*HttpInputOption, diag.Diagnostics) {
	...
	return &HttpInputOption{
		...
		CsvParser:                             parser.NewCsvParser(ctx, httpInputOption.CsvParser),
		JsonlParser:                           parser.NewJsonlParser(ctx, httpInputOption.JsonlParser),
		JsonpathParser:                        parser.NewJsonPathParser(ctx, httpInputOption.JsonpathParser),
		LtsvParser:                            parser.NewLtsvParser(ctx, httpInputOption.LtsvParser),
		ExcelParser:                           parser.NewExcelParser(ctx, httpInputOption.ExcelParser),
		XmlParser:                             parser.NewXmlParser(ctx, httpInputOption.XmlParser),
...
func (httpInputOption *HttpInputOption) ToInput(ctx context.Context) (*parameter.HttpInputOptionInput, diag.Diagnostics) {
	...
	return &parameter.HttpInputOptionInput{
		...
		CsvParser:                             httpInputOption.CsvParser.ToCsvParserInput(ctx),
		JsonlParser:                           httpInputOption.JsonlParser.ToJsonlParserInput(ctx),
		JsonpathParser:                        httpInputOption.JsonpathParser.ToJsonpathParserInput(ctx),
		LtsvParser:                            httpInputOption.LtsvParser.ToLtsvParserInput(ctx),
		ExcelParser:                           httpInputOption.ExcelParser.ToExcelParserInput(ctx),
		XmlParser:                             httpInputOption.XmlParser.ToXmlParserInput(ctx),
