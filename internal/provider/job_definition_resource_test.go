...
func TestAccJobDefinitionResourceMysqlToGcsCSV(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ResourceName: resourceName,
				Config:       providerConfig + LoadTextFile("testdata/job_definition/mysql_to_gcs/create_csv.tf"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccJobDefinitionResourceMysqlToGcsJSONL(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ResourceName: resourceName,
				Config:       providerConfig + LoadTextFile("testdata/job_definition/mysql_to_gcs/create_jsonl.tf"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccJobDefinitionResourceBigQueryToGoogleDrive(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ResourceName: resourceName,
				Config:       providerConfig + LoadTextFile("testdata/job_definition/bigquery_to_google_drive/create.tf"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccJobDefinitionResourcePagerdutyToBigQuery(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: providerConfig + LoadTextFile("testdata/job_definition/pagerduty_to_bigquery/create.tf"),
				Check: resource.ComposeAggregateTestCheckFunc(
