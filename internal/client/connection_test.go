...
// TestCreatePagerdutyConnection is auto-generated by tool. DO NOT EDIT.
func TestCreatePagerdutyConnection(t *testing.T) {
	s := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		assert.Equal(t, http.MethodPost, r.Method)
	...
	out, err := c.CreateConnection("pagerduty", &CreateConnectionInput{
		Name:   "Pagerduty Test",
		APIKey: lo.ToPtr("test-api_key"),
	})
