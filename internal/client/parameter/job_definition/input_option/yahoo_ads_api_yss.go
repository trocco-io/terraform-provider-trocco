...
type YahooAdsApiYssInputOptionInput struct {
	...
	Service                    string                                  `json:"srrvice"`
	ExcludeZeroImpressions     bool                                    `json:"exclude_zero_impressions"`
	ReportType                 *parameter.NullableString               `json:"report_type"`
	StartDate                  *parameter.NullableString               `json:"start_date"`
	EndDate                    *parameter.NullableString               `json:"end_date"`
	YahooAdsApiYssConnectionID *parameter.NullableInt64                `json:"yahoo_ads_api_yss_connection_id"`
...
type UpdateYahooAdsApiYssInputOptionInput struct {
	...
	YahooAdsApiYssConnectionID *parameter.NullableInt64                `json:"yahoo_ads_api_yss_connection_id,omitempty"`
