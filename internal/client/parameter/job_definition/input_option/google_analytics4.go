...
type GoogleAnalytics4InputOptionInput struct {
	...
	RetrySleep                            *parameter.NullableInt64                `json:"retry_sleep,omitempty"`
	RaiseOnOtherRow                       *bool                                   `json:"raise_on_other_row,omitempty"`
	LimitOfRows                           *parameter.NullableInt64                `json:"limit_of_rows,omitempty"`
...
type UpdateGoogleAnalytics4InputOptionInput struct {
	GoogleAnalytics4ConnectionID          *parameter.NullableInt64                                 `json:"google_analytics4_connection_id,omitempty"`
...
type GoogleAnalytics4Dimension struct {
	Name       string                    `json:"name"`
	Expression *parameter.NullableString `json:"expression,omitempty"`
}
