...
type SnowflakeOutputOptionInput struct {
	...
	SnowflakeOutputOptionColumnOptions []SnowflakeOutputOptionColumnOptionInput `json:"snowflake_output_option_column_options,omitempty"`
	SnowflakeOutputOptionMergeKeys     []string                                 `json:"snowflake_output_option_merge_keys,omitempty"`
