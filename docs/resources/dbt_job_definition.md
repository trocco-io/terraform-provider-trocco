...
- `options` (Attributes List) Command options. Omitting the attribute or setting it to `[]` both clear the options. (see [below for nested schema](#nestedatt--commands--options))
